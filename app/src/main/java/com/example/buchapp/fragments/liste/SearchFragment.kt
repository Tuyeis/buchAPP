...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnSearchBook.setOnClickListener {
            if(binding.etSearchBook.text== null || binding.nummerBook.text ==null ){

                Toast.makeText(context,"Algun campo esta vacio",Toast.LENGTH_SHORT).show()
            }else{

                api = Api(binding.etSearchBook.text.toString(), binding.nummerBook.text.toString().toInt(),context)
                ...
                CoroutineScope(Dispatchers.IO).launch {
                   ...
                   val author = buch.authors
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        binding.bookAuthor.text = author?.key.toString()
